...
\begin{figure}[H]
    ...
    \end{center}
    \captionof{figure}{Flow chart of the golfer interacting with the caddy on a club suggestion through the caddy}
    \label{fig:gui}
\end{figure}
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{|l|l|}
            ...
            MyMap & To showcase a virtual map of the golf course to indicate the
            live location of the golfer \\ \hline
            MyInfo & To allow the golfer to key in their information which
            includes age and skill level for the machine learning algorithm \\\hline
            MyClubs & To allow the golfer to key in the information of the
            location of each club in each slots in the golf bag. This GUI also
            allows the golfer to interact with the caddy on whether they decide
...
\begin{table}[]
    ...
    \captionof{table}{Average shot distance with different clubs for men and women of different skill levels}
...
\begin{table}[]
    ...
    Algorithm name &       &       &          &        & Female &        &        &        \\
    Classifiers          & Accuracy score         &                      & Execution Time (s) & Excellent & Beginner & Average & Good   & Excellent \\
    KNN            & 0.21  &       & 1.8      & 210.20 & 173.70 & 201.10 & 228.50 & 255.90 \\
    Decision Tree  & 0.22  &       & 0.04     & 192    & 155.40 & 192    & 205.70 & 214.80 \\
    Naives Bayes   & 0.23  &       & 0.02     & 182.80 & 137.10 & 178.20 & 187.40 & 201.10 \\
    Kernel SVM     & N/A   &       & Too long & 178.20 & 132.50 & 164.50 & 173.70 & 192    \\
    Random forest  & 0.96  &       & 58.8     & 173.70 & 132.50 & 164.50 & 173.70 & 196.50 \\
                   &       &       &          & 169.10 & 123.40 & 155.40 & 164.50 & 187.40 \\
    Regression           & \#R\textasciicircum{}2 & R\textasciicircum{}2 & 137.10             & 164.50    & 114.30   & 146.30  & 155.40 & 178.20    \\
    R\textasciicircum{}2 & 73.10                  & 100.50               & 128                & 155.40    & 109.70   & 141.70  & 150.80 & 169.10    \\
    6 Iron         & 64    & 91.40 & 118.80   & 146.30 & 105.10 & 132.50 & 146.30 & 160    \\
    7 Iron         & 59.40 & 82.30 & 109.70   & 137.10 & 96     & 128    & 137.10 & 150.80 \\
    8 Iron         & 54.80 & 73.10 & 100.50   & 128    & 86.80  & 118.80 & 128    & 141.70 \\
    9 Iron         & 50.30 & 64    & 86.80    & 118.80 & 73.10  & 105.10 & 114.30 & 132.50 \\
    Pitching Wedge & 45.70 & 54.80 & 73.10    & 105.10 & 64     & 91.40  & 100.50 & 123.40 \\
    Gap Wedge      & 41.10 & 50.30 & 64       & 86.80  & 54.80  & 82.30  & 91.40  & 114.30 \\
    Sand Wedge     & 36.60 & 45.70 & 54.80    & 77.70  & 50.30  & 73.10  & 86.80  & 105.10 \\
    Lob Wedge      & 32    & 41.10 & 45.70    & 64     & 36.60  & 54.80  & 73.10  & 96    
    \end{tabular}%
    }
    \captionof{table}{Performance of different machine learning algorithms}
...
\begin{table}[]
    ...
    \multicolumn{1}{c}{} &
      \multicolumn{1}{c}{username} &
      \multicolumn{1}{c}{age} &
      \multicolumn{1}{c}{gender} &
      \multicolumn{1}{c}{skill\_level} &
      \multicolumn{1}{c}{handicap} &
      \multicolumn{1}{c}{linear\_dist} &
      \multicolumn{1}{c}{actual\_dist} &
      \multicolumn{1}{c}{missed\_dist} &
      \multicolumn{1}{c}{club} &
      \multicolumn{1}{c}{actual\_club} &
      \multicolumn{1}{c}{aimed\_dir} &
      \multicolumn{1}{c}{wind\_dir} &
      \multicolumn{1}{c}{ws} &
      \multicolumn{1}{c}{angle\_dev} &
      \multicolumn{1}{c}{tendency} &
      \multicolumn{1}{c}{temp} &
      \multicolumn{1}{c}{height\_above\_sea\_level} &
      \multicolumn{1}{c}{elev\_diff} \\
    \multicolumn{1}{c}{28,701} &
      \multicolumn{1}{c}{Kathryn} &
      \multicolumn{1}{c}{19} &
      \multicolumn{1}{c}{Female} &
      \multicolumn{1}{c}{Average} &
      \multicolumn{1}{c}{21} &
      \multicolumn{1}{c}{96.90} &
      \multicolumn{1}{c}{110.70} &
      \multicolumn{1}{c}{13.80} &
      \multicolumn{1}{c}{4 Iron} &
      \multicolumn{1}{c}{6 Iron} &
      \multicolumn{1}{c}{51} &
      \multicolumn{1}{c}{191} &
      \multicolumn{1}{c}{9.40} &
      \multicolumn{1}{c}{94.10} &
      \multicolumn{1}{c}{right} &
      \multicolumn{1}{c}{29.30} &
      \multicolumn{1}{c}{180.60} &
      \multicolumn{1}{c}{-10} \\
    \multicolumn{1}{c}{25,065} &
      \multicolumn{1}{c}{Heather} &
      \multicolumn{1}{c}{68} &
      \multicolumn{1}{c}{Female} &
      \multicolumn{1}{c}{Excellent} &
      \multicolumn{1}{c}{2} &
      \multicolumn{1}{c}{133.60} &
      ...
      \multicolumn{1}{c}{top} &
      \multicolumn{1}{c}{5.60} &
      \multicolumn{1}{c}{356.40} &
      \multicolumn{1}{c}{-2} \\
    \multicolumn{1}{c}{11,524} &
      \multicolumn{1}{c}{Roger} &
      \multicolumn{1}{c}{51} &
      \multicolumn{1}{c}{Male} &
      \multicolumn{1}{c}{Average} &
      \multicolumn{1}{c}{24} &
      \multicolumn{1}{c}{203.50} &
      \multicolumn{1}{c}{231.40} &
    ...
    \captionof{table}{Sample sythetic data}
