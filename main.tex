...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.3\textwidth]{design_process.png}
    \end{center}
...
in the introduction.
\paragraph{Follow the golfer automatically}
yes but actually no

\paragraph{Offer the optimal club to the golfer}
conclusion is yes
...
Conclusion of innovative systems.

\subsubsection{Process}
Conclusion of how our design process was met. Validation etc

\subsubsection{Communication}
How did our meetings run, was it successful.
\end{multicols}
