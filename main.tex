...
built throughout the year. Building and using a simulator allowed writing
and testing of all the control software / algorithms that would be required to make
