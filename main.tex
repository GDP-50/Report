...
via and serial communication. The communication interface for this was written
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{|l|l|}
            ...
            MyInfo & \makecell{To allow the golfer to key in their information which \\
...
points within the perimeter of the area that the AGC should avoid. Once of
...
module allowing us to work with an APIs and remote access the system through ssh. The
...
these relationships have been use to simulate the actual distance each identity
